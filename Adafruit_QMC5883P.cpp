...
Adafruit_QMC5883P::Adafruit_QMC5883P(void)
    : i2c_dev(NULL), _lsb_per_gauss(1000.0F) {}
...
bool Adafruit_QMC5883P::softReset() {
  ...
  // Synchronize sensitivity with the actual post-reset range.
  _updateSensitivity(getRange());
  return true;
}
...
void Adafruit_QMC5883P::_updateSensitivity(qmc5883p_range_t range) {
  ...
  case QMC5883P_RANGE_30G:
    _lsb_per_gauss = 1000.0F;
    break;
  case QMC5883P_RANGE_12G:
    _lsb_per_gauss = 2500.0F;
    break;
  case QMC5883P_RANGE_8G:
    _lsb_per_gauss = 3750.0F;
    break;
  case QMC5883P_RANGE_2G:
    _lsb_per_gauss = 15000.0F;
    break;
  default:
    _lsb_per_gauss = 1000.0F;
    break;
